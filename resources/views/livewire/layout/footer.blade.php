    ...
    <div class="flex justify-between items-center ">
        ...
        <div class="flex justify-center items-center space-x-1">
            <a href="#" data-tooltip-target="tooltip-facebook"
                class="inline-flex justify-center p-2 text-gray-700 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
            ...
            <div id="tooltip-facebook" role="tooltip"
                ...
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1067px, 76px);">
                Like us on Facebook
                <div class="tooltip-arrow" data-popper-arrow=""
                    style="position: absolute; left: 0px; transform: translate(81px, 0px);"></div>
            </div>
            ...
            <div id="tooltip-twitter" role="tooltip"
                class="inline-block absolute z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm transition-opacity duration-300 tooltip dark:bg-gray-700 opacity-0 invisible"
                data-popper-placement="bottom"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1108px, 76px);">
                Follow us on Twitter
                <div class="tooltip-arrow" data-popper-arrow=""
                    style="position: absolute; left: 0px; transform: translate(79px, 0px);"></div>
            </div>
            ...
            <div id="tooltip-github" role="tooltip"
                ...
                data-popper-placement="bottom"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1156px, 76px);">
                Star us on GitHub
                <div class="tooltip-arrow" data-popper-arrow=""
                    style="position: absolute; left: 0px; transform: translate(72px, 0px);"></div>
            </div>
            ...
            <div id="tooltip-dribbble" role="tooltip"
                class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700"
                data-popper-placement="bottom"
                style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1150px, 76px);">
                Follow us on Dribbble
                <div class="tooltip-arrow" data-popper-arrow=""
                    style="position: absolute; left: 0px; transform: translate(118px, 0px);"></div>
            </div>
        </div>
    </div>
</footer>
