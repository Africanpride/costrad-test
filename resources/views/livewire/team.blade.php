<div class="">
    ...
    <div
        ...
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center md:max-w-5xl md:mb-12 space-y-4">
            ...
            <div class="text-gray-700  dark:text-gray-200 text-xl md:text-2xl py">
                Introducing our exceptional team of faculty members with diverse specialties, united by a global perspective. Together, we bring a wealth of knowledge, experience, and expertise to foster innovative learning and address complex challenges on a worldwide scale.
            </div>
        </div>
