    ...
    <div class="w-full mx-auto">
        <div class="relative bg-indigo-700 shadow-lg rounded-lg p-5 overflow-hidden">
            <!-- Illustration -->
            ...
            <div class="relative py-7">
                ...
                <x-admin.generic-button class="py px-3 bg-indigo-600"
                    onclick="Livewire.emit('openModal', 'admin.insurance.add-insurance')">
                    <span class="flex items-center justify-center gap-2">
                        <x-heroicon-o-queue-list class="w-5 h-5 text-white text-xs " />
                        View Schedule
                    </span>
