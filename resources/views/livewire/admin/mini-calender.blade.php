...
<div class="flex items-center justify-center  ">
    ...
    <div class=" w-full shadow-lg">
        <div class="p-4 dark:bg-gray-900 bg-gray-200 rounded-t">
        ...
        {{-- Take 3 of daily schedule. (TIME, TITLE, LINE CLAMPM OF AGENDA) --}}
        <div class="p-4 dark:bg-gray-800 bg-gray-100 rounded-b">
            <div class="px-4">
                ...
                <div class=" pb-4 border-gray-400 border-dashed pt-5">
                    <p class="text-xs font-light leading-3 text-gray-500 dark:text-gray-300">9:00 AM</p>
                    <a tabindex="0"
                        class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Zoom
                        call with design team</a>
