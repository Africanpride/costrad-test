    ...
    <div class="bg-white dark:bg-gray-800 py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl sm:text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">Distinctio et nulla eum soluta et
                    neque
                    labore quibusdam. Saepe et quasi iusto modi velit ut non voluptas in. Explicabo id ut laborum.</p>
            </div>
            <div
                ...
                <div class="p-8 sm:p-10 lg:flex-auto">
                    ...
                    <p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-300">Lorem ipsum dolor sit amet
                        consect
                ...
                <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                    <div
                        class="rounded-2xl bg-gray-200/30 dark:bg-gray-900/30 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                        <div class="mx-auto max-w-xs px-8">
                            ...
                            <a href="#"
                                ...
                                access</a>
                            <p class="mt-6 text-xs leading-5 text-gray-600 dark:text-gray-400">Invoices and receipts
