<div class="text-center grid place-items-center space-y-6 py-16">
    ...
    <div class="max-w-5xl space-y-4 ">
        <p class=" text-3xl font-bold
         text-slate-800 px-5 text-gradient1">
            Transform your life and pursue your dreams in our 5-week <span>COSTrAD</span>
    ...
    <div class="text-center w-full mx-auto">
        <a href="{{ route('institute.show', [$costrad->slug]) }}"> <button class="cbutton !py-1 w-24 font-bold">Learn More About
                costrad</button>
        </a>
    </div>
</div>
