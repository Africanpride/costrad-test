<x-app-layout>
    <x-admin.pageheader model-name="Announcements" description="Announcement Management" add-button="false"
        class="mx-4">
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="flex justify-end items-center my-10">
                <x-jet-button class="mt-2 mr-2 md:w-auto flex justify-center items-center gap-2"
                    onclick="Livewire.emit('openModal', 'admin.announcement.add-announcement')" type="button">
                    ...
                    <article
                        ...
                        <div class="rounded-[10px] bg-white dark:bg-black p-4  !pt-20  sm:p-6 relative">
                            <div class="absolute top-2 left-2 cursor-pointer"
                                onclick="Livewire.emit('openModal', 'admin.announcement.update-announcement', {{ json_encode([$announcement->id]) }})">
                                <div
                            ...
                            <div class="absolute top-2 right-2 cursor-pointer"
                                onclick="Livewire.emit('openModal', 'admin.announcement.delete-announcement', {{ json_encode([$announcement->id]) }})">
                                <div
