...
123
        ...
        <div x-data="scrollProgress"
            ...
            <svg class="w-20 h-20">
                <circle class="text-gray-300" stroke-width="5" stroke="currentColor" fill="transparent" r="30"
                    cx="40" cy="40" />
                <circle class="text-firefly-600" stroke-width="5" :stroke-dasharray="circumference"
            ...
            <span class="absolute text-xl text-firefly-700" x-text="`${percent}%`"></span>
        </div>

        <!-- Social links -->
        <div class="hidden fixed flex flex-col items-center space-y-4 bottom-5 right-5">
            <a href="https://twitter.com/ak_kamona" target="_blank"
                class="transition-transform transform hover:scale-125">
                <span class="sr-only">Twitter</span>
                <svg aria-hidden="true" class="w-8 h-8 text-firefly-500" fill="currentColor"
